...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  'home.welcome': {
    ...
    [Language.ZH_CN]: '欢迎来到我们的数字记忆胶囊。',
    [Language.ZH_TW]: '歡迎來到我們的數位記憶膠囊。',
  },
  'home.cta': {
    [Language.EN]: 'View Photos',
    [Language.ZH_CN]: '查看相册',
    [Language.ZH_TW]: '查看相簿',
  },
  'home.cta.guestbook': {
